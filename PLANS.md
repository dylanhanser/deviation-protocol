...
The implementation candidate supplies one archive visit after the held-receipt
ending, both archive endings, three-visit recovery/history, explicit exit and
separately confirmed same-character admission. It remains unstaged/uncommitted
and awaits focused independent re-review after the latest CHANGES_REQUIRED verdict (F1 closed, original ACTIVE-View mismatch corrected, automatic Journey/status consistency corrected locally); automated evidence and
its limits are recorded in [S7-3 evidence](docs/run_protocol.md#s7-3-implementation-candidate-evidence).
No browser acceptance, limited trial, broader release, S7 or Phase 3.3 completion
is claimed. S7-4/5 retain their ownership; DF-001/DF-002 remain deferred.
...
Required automated verification is recorded for the S7-3 candidate. The next
step is focused independent re-review of the corrected frozen bytes and replacement Web evidence. Its published plan and P01–P09
are approved; later work retains the frozen S7 allocation.
...
browser evidence. S7-3 plan is published at `0ea295e`, P01–P09 are approved, and its authorized
implementation candidate awaits focused independent re-review. S7-4/5
remain outside this increment. DF-001 and reassessed DF-002
...
- The exact P3.3-S2 numeric domains, profile defaults, override catalogue,
  ...
  plan is approved and published at `0ea295e`; its local implementation candidate
  awaits focused independent re-review after the automatic Journey/status consistency correction.
- Later authored-world weighting, visits/regions/world state, progression,
  ...
  published. S7-2's minimum visits/state/selection follow its approved published plan;
  revisit, regional progression and later continuity retain the published S7
  allocation. The S3 persistence
