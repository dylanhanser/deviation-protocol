...
CURRENT_HEAD_REVISION = "20260918_0010"
...
def test_phase_2_metadata_has_exact_six_table_contract() -> None:
    assert set(Base.metadata.tables) == (
        ...
        | PHASE_2_TABLE_SET
        | MINIMUM_RUN_CORE_TABLES
        | {"run_protocol_bindings", "run_entry_world_bindings", "run_world_states", "run_world_visits", "run_world_positions", "run_world_visit_entries"}
    )
