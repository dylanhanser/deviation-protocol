...
passed/124 expected skips, MySQL 136 passed, and Full 1,937 passed/one opt-in
  ...
  authority at `de4d8c0e35c7864948306d751a00aaf295ff77ff`, so P8-G0 is
  complete and published. P8-S1 eligible-character discovery is implemented,
...
approved planning authority alone authorized no implementation. P8-S1
...
`e17172ad0a9febe4ec9e3a96e7be8204c9722d29`. Its implementation provides
...
accepted implementation. It follows
  ...
  and unimplemented. Phase 8 has approved and published planning authority.
  ...
  approved and published. Its implementation contains the normal adapter and
  composition. The first independent review returned
